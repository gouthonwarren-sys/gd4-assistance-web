-- GD4 — Quota TOKENS + Codes promo (003)
...
-- RPC consommation atomique input+output (fenêtre 8h).
...
-- Consommation réservée aux utilisateurs connectés (via RLS + SECURITY DEFINER).
